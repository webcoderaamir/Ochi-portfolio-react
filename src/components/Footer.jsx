...
const Footer = () => {
  return (
    <div className="w-full h-screen p-14 flex gap-5 bg-[#f1f1f1]">

      <div className="open w-1/2 h-full flex flex-col justify-between ">
        <div className="heading">
          <h1 className="text-[8.3vw] uppercase leading-[8.8vw] -mb-10 font-semibold ">
            EYE-
          </h1>
          <h1 className="text-[8.3vw] uppercase leading-[8.8vw] -mb-10 font-semibold ">
            OPENING
      ...
      <div className="w-1/2">
        <h1 className="prs text-[8.3vw] uppercase leading-[8.8vw] -mb-10 font-semibold ">
          PRESENTATIONS
        </h1>
          <div className="dets mt-10">
            <a className="block text-md font-light" href="#">Facebook</a>
            <a className="block text-md font-light" href="#">Instagram</a>
            <a className="block text-md font-light" href="#">Linkedin</a>
            <a className="block text-md font-light" href="#">Behance</a>
          </div>
      </div>
    </div>
  );
